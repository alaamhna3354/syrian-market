                        ...
                        <div class="d-flex d-lg-flex d-md-block align-items-center justify-content-between">
                            <div>
                                <div class="d-inline-flex align-items-center">
                                    <h2 class="text-white shadow-h  mb-1 font-weight-medium"><sup class="set-doller">{{config('basic.currency_symbol')}}</sup>{{getAmount(auth()->user()->balance)}}
                                    </h2>
                                </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="card shadow">
                    <div class="card-body">
                        <div class="d-flex d-lg-flex d-md-block align-items-center justify-content-between">
                            <div>
                                <h2 class="text-white shadow-h  mb-1 w-100 text-truncate font-weight-medium">{{count(auth()->user()->transactions)}}</h2>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="card shadow">
                    <div class="card-body">
                        <div class="d-flex d-lg-flex d-md-block align-items-center justify-content-between">
                            <div>
                                <h2 class="text-white shadow-h  mb-1 font-weight-medium">{{count(auth()->user()->ticket)}}</h2>
                ...
                <div class="card shadow">
                    <div class="card-body">
                        <div class="d-flex d-lg-flex d-md-block align-items-center justify-content-between">
                            <div>
                                <div class="d-inline-flex align-items-center">
                                    <h2 class="text-white shadow-h  mb-1 font-weight-medium">{{count(auth()->user()->order)}}</h2>
                                </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="card shadow">
                    <div class="card-body">
                        <div class="d-flex d-lg-flex d-md-block align-items-center justify-content-between">
                            <div>
                                <h2 class="text-white shadow-h  mb-1 font-weight-medium">{{count(auth()->user()->order->where('status','processing'))}}</h2>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="card shadow">
                    <div class="card-body">
                        <div class="d-flex d-lg-flex d-md-block align-items-center justify-content-between">
                            <div>
                                <h2 class="text-white shadow-h  mb-1 font-weight-medium">{{count(auth()->user()->order->where('status','pending'))}}</h2>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <div class="card shadow">
                    <div class="card-body">
                        <div class="d-flex d-lg-flex d-md-block align-items-center justify-content-between">
                            <div>
                                <h2 class="text-white shadow-h  mb-1 font-weight-medium">{{count(auth()->user()->order->where('status','completed'))}}</h2>
                            ...
                            <div>
                                <div class="d-inline-flex align-items-center">
                                    <h2 class="text-white shadow-h  mb-1 font-weight-medium">
                                        {{count(auth()->user()->children)}}
                                    </h2>
                                </div>
                                <h6 class="text-white shadow-h  font-weight-normal mb-0 w-100 text-truncate">@lang('Your Users')</h6>
                            </div>
