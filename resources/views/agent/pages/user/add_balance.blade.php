...
@section('title')
    @lang('Add Balance To User')
@endsection
@section('content')
    <div class="container">
        <ol class="breadcrumb center-items">
            <li><a href="{{route('user.home')}}">@lang('Home')</a></li>
            <li class="active">@lang('Add Balance To User')</li>
        </ol>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form class="form" method="post" action="{{route('agent.user.add-balance-to-user')}}" enctype="multipart/form-data">
                                    @csrf
