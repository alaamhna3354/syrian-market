                    ...
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0 p-0">
                                ...
                                <li class="breadcrumb-item text-muted text-capitalize" aria-current="page">@yield('title')</li>
                            </ol>
                        </nav>
                    </div>
        ...
        methods: {
            ...
            pushNewItem() {
                ...
                channel.bind('App\\Events\\AdminNotification', function (data) {
                    ...
                    const audio = new Audio('https://assets.mixkit.co/sfx/preview/mixkit-urgent-simple-tone-loop-2976.mp3');
                    audio.play();
