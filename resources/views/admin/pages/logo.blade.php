                            ...
                            <div id="home"
                                ...
                                <form action="{{ route('admin.logoUpdate')}}" method="post"
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="image-input ">
                                                    <label for="image-upload" id="image-label"><i
                                                            class="fas fa-upload"></i></label>
                                                    <input type="file" name="favicon" placeholder="Choose image"
                                                           id="favicon">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="font-weight-bold">@lang('Footer Logo')</label>
                                                <div class="image-input">
                                                    <label for="image-upload" id="image-label"><i
                                                            class="fas fa-upload"></i></label>
                                                    <input type="file" name="footer_image" placeholder="Choose image"
                                                           id="image">
                                                    <img id="image_preview_container" class="preview-image"
                                                         src="{{getFile(config('location.logo.path').'footer-logo.png') ? : 0}}"
                                                         alt="preview image">
                                                </div>
                                                @error('image')
                                                <span class="text-danger">{{$message}}</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="image-input ">
                                                    <label for="meta_image-upload" id="image-label"><i
                                                            class="fas fa-upload"></i></label>
                                                    <input type="file" name="meta_image" placeholder="Choose image"
                                                           id="meta_image">
