                ...
                <div class="row justify-content-between">
                    <div class="col-sm-6 col-md-6">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" name="sale" value="{{old('sale')}}"
                                   class="form-control form-control-sm">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="number" name="number_of_beneficiaries" value="{{old('number_of_beneficiaries')}}"
                                   class="form-control form-control-sm">
                            <div class="invalid-feedback">@lang('Please fill in the Balance')</div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <div class="custom-switch-btn">
                                        ...
                                        <input type="checkbox" name="is_percent" class="custom-switch-checkbox"
                                               id="is_percent" value="0" checked>
