...
@section('content')
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0">
        <div class="card-body">
            <form method="post" action=" {{ route('admin.balance-coupon.update',$coupon->id) }} " enctype="multipart/form-data">
                @csrf
                <div class="row justify-content-between">
                        ...
                        <div class="form-group">
                            <div class="image-input ">
                                ...
                                <img id="image_preview_container" class="preview-image"
                                     src="{{ getFile(config('location.category.path').$coupon->qr_code)}}"
                                     alt="preview image">
                            </div>
                    ...
                    <div class="col-sm-6 col-md-8">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" name="balance" value="{{old('balance',$coupon->balance)}}"
                                   class="form-control form-control-sm">
