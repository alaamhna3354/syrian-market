                    ...
                    @foreach($coupons as $coupon)
                        <tr>
                            <td class="text-center">
                                <input type="checkbox" id="chk-{{$coupon->id}}"
...
{{--                                           class="dropdown-item status-change {{ $coupon->status == 0 ? 'text-success' : 'text-danger' }}"--}}
{{--                                           data-toggle="modal"--}}
{{--                                           data-target="#statusMoldal"--}}
{{--                                           data-route="{{route('admin.category.status.change',['id'=>$coupon->id])}}">--}}
{{--                                            <i class="fa fa-check "--}}
{{--                                               aria-hidden="true"></i>--}}
{{--                                            {{ $coupon->status == 0 ? 'Activate' : 'Deactivate' }}--}}
{{--                                        </a>--}}
                                    </div>
                                </div>
