...
@section('content')
    ...
    <div class="card card-primary card-form m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body ">
            <form action="{{route('admin.service_codes.store-multi')}}" method="POST" class="form">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>@lang('Codes')</label>
                            <p class="label label-default">@lang('Each Code On New Line')</p>
                            <textarea class="form-control" rows="6" placeholder="e.g. 4775839022" name="code"></textarea>
                            @if($errors->has('code'))
