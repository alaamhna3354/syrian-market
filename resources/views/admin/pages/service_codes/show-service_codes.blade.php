...
{{--        <div class="row ">--}}
{{--            <div class="col-xl-10">--}}
{{--                <form action="{{ route('admin.service_codes-search') }}" method="get">--}}
{{--                    <div class="row">--}}
{{--                        <div class="col-md-4 col-xl-3">--}}
{{--                            <div class="form-group">--}}
{{--                                <input type="text" name="service_code" value="{{@request()->service}}" class="form-control"--}}
...
{{--                        <div class="col-md-4 col-xl-3">--}}
{{--                            <div class="form-group">--}}
{{--                                <select name="service" id="service" class="form-control statusfield">--}}
{{--                                    <option value="-1" @if(@request()->service == '-1') selected @endif>@lang('All Category')</option>--}}
{{--                                    @foreach($services as $service)--}}
{{--                                        <option value="{{$service->id}}" @if(@request()->service == $service->id) selected @endif>@lang($service->service_title)</option>--}}
{{--                                    @endforeach--}}
{{--                                </select>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--    </div>--}}
    ...
    @foreach($services as $key =>  $service)
        <div class="card card-primary m-0 m-md-4 my-4 m-md-0">
            <div class="card-body">
                <h4 class="card-title"> @lang($service->service_title)</h4>
                            ...
                            <tr>
                                <td class="text-center check-box-width-50">
                                    <input type="checkbox"
                                           ...
                                           name="check" value="{{ $service_code->id }}" data-id="{{ $service_code->id }}">
                                    <label for="service-tic-{{ $service_code->id }}"></label>
                                </td>

                                <td data-label="@lang('ID')" >@lang($service_code->id)</td>

                                <td data-label="@lang('Name')" class="text-right text-lg-left" >
                                    <a href="javascript:void(0)" data-container="body"  data-toggle="popover" data-placement="top" data-content="{{$service_code->code}}">
                                        {{$service_code->code}}
                                    </a>
                                </td>
...
{{--                                           data-route="{{route('admin.service_codes-active',['id'=>$service_code->id])}}">--}}
...
{{--                                           data-target="#statusMoldal"--}}
{{--                                           data-route="{{route('admin.service_codes-deactive',['id'=>$service_code->id])}}">--}}
...
{{--                                    @endif--}}
                                       ...
                                       <button type="button" class="btn btn-secondary btn-rounded btn-sm" data-toggle="modal"
                                               ...
                                               data-servicetitle="{{$service_code->service->service_title}}"
    ...
    @if($services->total() > config('basic.paginate'))
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0">
        <div class="card-body">
        {{ $services->links() }}
        </div>
