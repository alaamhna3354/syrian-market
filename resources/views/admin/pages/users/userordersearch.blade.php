                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <input type="text" name="search" value="{{@request()->search}}" class="form-control get-service"
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            ...
            <table class="categories-show-table table table-hover table-striped table-bordered">
                        ...
                        <td data-label="@lang('Action')">
                            <div class="dropdown show">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    ...
                                    <a class="dropdown-item status-change" data-toggle="modal"
                ...
                @empty
                    <tr>
                        <td class="text-center text-danger" colspan="15">@lang('No User Order Data')</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-body">
                    <h1><i class="fas fa-sync-alt position-absolute"></i></h1>
                ...
                <div class="modal-footer">
                    <form action="" method="post" id="changeOrderStatus">
                        @csrf
                        <a href="" class="btn btn-swap awaiting-yes" data-status=""><span>Yes</span></a>
                    </form>
                    <button type="button" class="btn btn-swap red" data-dismiss="modal"><span>No</span></button>
                </div>
            </div>
        </div>
    </div>
