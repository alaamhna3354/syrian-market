...
@section('content')
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0">
        <div class="card-body">
            <form method="post" action=" {{ route('admin.price_range.update',$range->id) }} " enctype="multipart/form-data">
                @csrf
                <div class="row justify-content-between">
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group ">
                            <label>@lang('Name')</label>
                            <input type="text" name="name" value="{{old('name',$range->name)}}"
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" name="min_total_amount" value="{{old('min_total_amount',$range->min_total_amount)}}"
                                   class="form-control form-control-sm">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group ">
                            ...
                            <input type="number" name="limit_days" value="{{old('limit_days',$range->limit_days)}}"
                                   class="form-control form-control-sm">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" name="min_total_amount_to_stay" value="{{old('min_total_amount_to_stay',$range->min_total_amount_to_stay)}}"
                                   class="form-control form-control-sm">
                            <div class="invalid-feedback">@lang('Please fill in the Min Total Amount')</div>
                    ...
                    <input type="hidden" name="id" value="{{old('id',$range->id)}}" required="required" class="form-control form-control-sm">
                    <div class="col-sm-6 col-md-12">
                        <div class="submit-btn-wrapper mt-md-5 text-center text-md-left">
                            <button type="submit"
                                ...
                                <span>@lang('Update Price Range')</span></button>
                        </div>
                    </div>
                </div>
            </form>
