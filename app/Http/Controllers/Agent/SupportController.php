...
class SupportController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('agent.pages.support.index', compact('tickets', 'page_title'));
    }
    ...
    public function create()
    {
        ...
        $user = $this->user;
        return view('agent.pages.support.create', compact('page_title', 'user'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('agent.ticket.list')->with('success', trans('Your Ticket has been pending'));
    }
    ...
    public function view($ticketId)
    {
        ...
        $user = $this->user;
        return view('agent.pages.support.view', compact('ticket', 'page_title', 'user'));
    }
